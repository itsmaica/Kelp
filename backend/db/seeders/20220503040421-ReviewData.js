...
module.exports = {
  up: (queryInterface, Sequelize) => {
   ...
   return queryInterface.bulkInsert('Reviews', [
      ...
      {
        name: 'A five mile long sand bar',
        userId: 8,
        beachId: 6,
        rating: 4,
